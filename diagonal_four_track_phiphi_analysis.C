...
void diagonal_four_track_phiphi_analysis() {
    ...
    const float phi_mass = 1.02116e+03;//1019.461
    ...
    const float maximum_fourtrack_eta = 1000000000000; //0.65
    const float maximum_fourtrack_p_t = 400;
    ...
    float fit_range = 50;
    float fit_center = 2.21901e+03;

    TF1 fJ_fit("fJ_fit", "[0]*TMath::Gaus(x,[1],[2])", fit_center-fit_range, fit_center+fit_range);
    fJ_fit.SetParameters(9.79279e+01, fit_center, 6.70673e+01);
    ...
    leg.AddEntry(four_track_mass, "#splitline{Diagonal event data with two track}{mass constraint (1021 #pm 15)MeV}", "LE");
    leg.AddEntry(&fJ_fit, "#splitline{Gaussian fit}{#splitline{Mean: (2219 #pm 5)MeV}{Standard deviation: (70 #pm 10)MeV}}");
    leg.DrawClone("Same");
